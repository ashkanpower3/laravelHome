...
<!-- breadcrumb-area -->
            ...
            <div class="row">
               <div class="col-xxl-12">
                  <div class="breadcrumb__content p-relative z-index-1">
                     <h3 class="breadcrumb__title mb-20">Instructor</h3>
                     <div class="breadcrumb__list">
                        <span><a href="index.html">Home</a></span>
                        <span class="dvdr"><i class="fa-regular fa-angle-right"></i></span>
                        <span class="sub-page-black">Instructor</span>
                     </div>
                  </div>
               </div>
            </div>
      ...
      <section class="instructor-area pb-110">
         <div class="container">
            ...
            <div class="row">
               ...
               <div class="col-lg-4 col-md-6 col-12">
                  <div class="tp-instruc-item">
                     <div class="tp-instructor text-center p-relative mb-40">
                        <div class="tp-instructor__thumb mb-25">
                           <img src="/assets/img/bg/instruc-in-02.jpg" alt="instructor-profile">
                        </div>
                        <div class="tp-instructor__content">
                           <span>Instructor</span>
               ...
               <div class="col-lg-4 col-md-6 col-12">
                  <div class="tp-instruc-item">
                     <div class="tp-instructor text-center p-relative mb-40">
                        <div class="tp-instructor__thumb mb-25">
                           <img src="/assets/img/bg/instruc-in-03.jpg" alt="instructor-profile">
                        </div>
                        <div class="tp-instructor__content">
                           <span>Instructor</span>
               ...
               <div class="col-lg-4 col-md-6 col-12">
                  <div class="tp-instruc-item">
                     <div class="tp-instructor text-center p-relative mb-40">
                        <div class="tp-instructor__thumb mb-25">
                           <img src="/assets/img/bg/instruc-in-04.jpg" alt="instructor-profile">
                        </div>
                        <div class="tp-instructor__content">
                           <span>Instructor</span>
                           <h4 class="tp-instructor__title tp-instructor__title-info p-relative mb-35 mt-5"><a href="instructor-profile.html">Wade Warren</a></h4>
                           <div class="tp-instructor__stu-info">
                              <ul class="d-flex align-items-center justify-content-center">
                                 <li class="d-flex align-items-center"><img src="/assets/img/icon/c-meta-01.png" alt="meta-icon"> <i>35 Classes</i></li>
                                 <li class="d-flex align-items-center"><img src="/assets/img/icon/c-meta-02.png" alt="meta-icon"> <i>291+ Students</i></li>
               ...
               <div class="col-lg-4 col-md-6 col-12">
                  <div class="tp-instruc-item">
                     <div class="tp-instructor text-center p-relative mb-40">
                        <div class="tp-instructor__thumb mb-25">
                           <img src="/assets/img/bg/instruc-in-05.jpg" alt="instructor-profile">
                        </div>
                        <div class="tp-instructor__content">
                           <span>Instructor</span>
                           <h4 class="tp-instructor__title tp-instructor__title-info p-relative mb-35 mt-5"><a href="instructor-profile.html">Leslie Alexander</a></h4>
                           <div class="tp-instructor__stu-info">
                              <ul class="d-flex align-items-center justify-content-center">
                                 <li class="d-flex align-items-center"><img src="/assets/img/icon/c-meta-01.png" alt="meta-icon"> <i>35 Classes</i></li>
                                 <li class="d-flex align-items-center"><img src="/assets/img/icon/c-meta-02.png" alt="meta-icon"> <i>291+ Students</i></li>
               ...
               <div class="col-lg-4 col-md-6 col-12">
                  <div class="tp-instruc-item">
                     <div class="tp-instructor text-center p-relative mb-40">
                        <div class="tp-instructor__thumb mb-25">
                           <img src="/assets/img/bg/instruc-in-06.jpg" alt="instructor-profile">
                        </div>
                        <div class="tp-instructor__content">
                           <span>Instructor</span>
                           <h4 class="tp-instructor__title tp-instructor__title-info p-relative mb-35 mt-5"><a href="instructor-profile.html">Esther Howard</a></h4>
                           <div class="tp-instructor__stu-info">
                              <ul class="d-flex align-items-center justify-content-center">
                                 <li class="d-flex align-items-center"><img src="/assets/img/icon/c-meta-01.png" alt="meta-icon"> <i>35 Classes</i></li>
                                 <li class="d-flex align-items-center"><img src="/assets/img/icon/c-meta-02.png" alt="meta-icon"> <i>291+ Students</i></li>
               ...
               <div class="col-lg-4 col-md-6 col-12">
                  <div class="tp-instruc-item">
                     <div class="tp-instructor text-center p-relative mb-40">
                        <div class="tp-instructor__thumb mb-25">
                           <img src="/assets/img/bg/instruc-in-07.jpg" alt="instructor-profile">
                        </div>
                        <div class="tp-instructor__content">
                           <span>Instructor</span>
                           <h4 class="tp-instructor__title tp-instructor__title-info p-relative mb-35 mt-5"><a href="instructor-profile.html">Guy Hawkins</a></h4>
                           <div class="tp-instructor__stu-info">
                              <ul class="d-flex align-items-center justify-content-center">
                                 <li class="d-flex align-items-center"><img src="/assets/img/icon/c-meta-01.png" alt="meta-icon"> <i>35 Classes</i></li>
                                 <li class="d-flex align-items-center"><img src="/assets/img/icon/c-meta-02.png" alt="meta-icon"> <i>291+ Students</i></li>
               ...
               <div class="col-lg-4 col-md-6 col-12">
                  <div class="tp-instruc-item">
                     <div class="tp-instructor text-center p-relative mb-40">
                        <div class="tp-instructor__thumb mb-25">
                           <img src="/assets/img/bg/instruc-in-08.jpg" alt="instructor-profile">
                        </div>
                        <div class="tp-instructor__content">
                           <span>Instructor</span>
                           <h4 class="tp-instructor__title tp-instructor__title-info p-relative mb-35 mt-5"><a href="instructor-profile.html">Annette Black</a></h4>
                           <div class="tp-instructor__stu-info">
                              <ul class="d-flex align-items-center justify-content-center">
                                 <li class="d-flex align-items-center"><img src="/assets/img/icon/c-meta-01.png" alt="meta-icon"> <i>35 Classes</i></li>
                                 <li class="d-flex align-items-center"><img src="/assets/img/icon/c-meta-02.png" alt="meta-icon"> <i>291+ Students</i></li>
               ...
               <div class="col-lg-4 col-md-6 col-12">
                  <div class="tp-instruc-item">
                     <div class="tp-instructor text-center p-relative mb-40">
                        <div class="tp-instructor__thumb mb-25">
                           <img src="/assets/img/bg/instruc-in-09.jpg" alt="instructor-profile">
                        </div>
                        <div class="tp-instructor__content">
                           <span>Instructor</span>
                           <h4 class="tp-instructor__title tp-instructor__title-info p-relative mb-35 mt-5"><a href="instructor-profile.html">Jacob Jones</a></h4>
                           <div class="tp-instructor__stu-info">
                              <ul class="d-flex align-items-center justify-content-center">
                                 <li class="d-flex align-items-center"><img src="/assets/img/icon/c-meta-01.png" alt="meta-icon"> <i>35 Classes</i></li>
                                 <li class="d-flex align-items-center"><img src="/assets/img/icon/c-meta-02.png" alt="meta-icon"> <i>291+ Students</i></li>
            ...
            <div class="row">
               <div class="col-lg-12">
                  <div class="instructor-btn text-center mt-20">
